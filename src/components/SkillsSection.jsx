    ...
    <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 scroll-mt-24">
      ...
      <div className="mt-12 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8">
        {Skills.map((skill, index) => (
          <motion.div
            key={skill.slug}
            className="flex flex-col items-center text-center bg-white dark:bg-gradient-to-br dark:from-gray-800 dark:to-black rounded-xl p-6 shadow-lg hover:shadow-2xl hover:shadow-blue-500/20 border border-gray-100 dark:border-gray-700 transition-all duration-300"
            {...fadeIn(index * 0.1)}
